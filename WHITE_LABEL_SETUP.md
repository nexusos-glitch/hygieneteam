...
This app requires mycanvaslab Cloud (powered by Supabase) for backend functionality. To enable:

1. Click "Connect mycanvaslab Cloud" in the mycanvaslab interface
2. The following database tables will be needed:
...
2. See mycanvaslab's Capacitor documentation for setup
...
3. Test all features
4. Deploy via mycanvaslab's publish feature
...
For technical support, refer to [mycanvaslab Documentation](https://docs.mycanvaslab.dev/)
